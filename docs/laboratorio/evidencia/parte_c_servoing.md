...
Trayectoria: `../../informe/figures/parte_c_trayectoria_c6.png` (la ✕ cian marca la estimación
...
Trayectoria: `../../informe/figures/parte_c_trayectoria_c7.png` (start → 2 waypoints → cono).
...
| Figura | Descripción |
|--------|-------------|
| `../../informe/figures/parte_c_cono_debug.png` | Imagen anotada del `cone_detector`: bounding box verde + centroide sobre el cono rojo (confianza 0.97, área 1937 px, bearing −2°). |
| `../../informe/figures/parte_c_cono_mask.png` | Máscara HSV: silueta del cono segmentada (2077 px). |
| `../../informe/figures/parte_c_cono_raw.png` | Frame crudo de la cámara OAK-D (preview 250×250) con el cono en cuadro. |
| `../../informe/figures/parte_c_laberinto_raw.png` | Vista del laberinto real (paredes de cartón) sin cono en cuadro. |
| `../../informe/figures/parte_c_trayectoria_c7.png` | Run de búsqueda (cono fuera de campo): secuencia de goals numerada (start=0 → waypoints → cono) sobre el mapa. |
| `../../informe/figures/parte_c_trayectoria_c6.png` | Run de servoing: la ✕ cian marca la estimación LIDAR sobre la pared que dispara el fallback. |
